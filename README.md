...
### feature [Return parameters enumerator from transform_keys/!](https://github.com/rails/rails/pull/36302)
* branch try101_parameters_transform_keys
* article:

### feature [Fix a bug where DebugExceptions errors out when malformed query parameters are provided](https://github.com/rails/rails/commit/7b00308161241ac93df707f7ec84bfe6ed46cf80)
* branch try100_malformed_url
* article:

### feature [Namespace association extension modules under the owner model](https://github.com/rails/rails/commit/d46a70892ff85b4d6b12b9ae5a6102ae07bb3dbb)
* branch try099_association_extension
* article:

### feature * [new config to opt-out from adding app directories to $LOAD_PATH](https://github.com/rails/rails/commit/668673f7793be1ce318a32bb622ed411029d00a9)
* branch try098_add_autoload_paths_to_load_path
* article:
...
* article: https://qiita.com/suketa/items/ccb65411d400a29a5b1a (日本語)
...
* branch try093_extract_associated
* article: https://qiita.com/suketa/items/5d747ee31ba5c44df703 (日本語)

### feature [Add config.disable_sandbox option to Rails console](https://github.com/rails/rails/pull/35723)
* branch try092_console_sandbox
* article: https://qiita.com/suketa/items/543ba634587166ee5655 (日本語)

### feature [Add support for annotating queries generated by ActiveRecord::Relation with SQL comments](https://github.com/rails/rails/pull/35617)
* branch try091_activerecord_annotate
* article: https://qiita.com/suketa/items/e92eae4dfa65ba1de009 (日本語)
...
* article: https://qiita.com/suketa/items/1dd3cd32f13a7d4c23ff (日本語)
